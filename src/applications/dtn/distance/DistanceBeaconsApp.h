...
#ifndef DISTANCEBEACONSAPP_H_
#define DISTANCEBEACONSAPP_H_

#include "BeaconsApp.h"
#include "DistanceNeighbor.h"
class DistanceBeaconsApp: public BeaconsApp {
public:
    DistanceBeaconsApp();
    virtual ~DistanceBeaconsApp();
    double getMySqrDistanceToPoa();
protected:
